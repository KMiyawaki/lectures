...
- `work24.html`のコメントを参照し、下記のコードを追記して実行結果を確認しなさい。なお、省略している部分は[前項](./three_js_01.md)とコメントを参考に埋めること。
...
- `work24.html`のコメントを参照し、下記のコードを追記して実行結果を確認しなさい。追記・修正箇所は 2 か所に渡っている。省略箇所はこれまでの内容から自力で考えること。
